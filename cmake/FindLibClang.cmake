if ("${CMAKE_SYSTEM_NAME}" STREQUAL "Windows" AND NOT CLANG_ROOT)
...
if (NOT CLANG_LIBS)
  ...
  if (NOT EXISTS ${CLANG_CLANG_LIB_HACK_CMAKECACHE_DOT_TEXT_BULLSHIT})
    find_library(CLANG_LIBS NAMES clang libclang PATHS ${CLANG_LIBDIR})
...
message("-- Using Clang ${CLANG_VERSION} from ${CLANG_LIBDIR} with LIBS ${CLANG_LIBS} With ${CLANG_INCLUDEDIR} and CXXFLAGS ${CLANG_CXXFLAGS}")

add_library(clang UNKNOWN IMPORTED)
set_target_properties(clang PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES "CXX"
  IMPORTED_LOCATION "${CLANG_LIBS}"
  INTERFACE_INCLUDE_DIRECTORIES "${CLANG_INCLUDEDIR}"
)
